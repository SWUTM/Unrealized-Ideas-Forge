package net.swutm.unrealizedideas.item.custom;
...
public enum ModArmorMaterials implements ArmorMaterial {
    LEATHER_AND_MAIL("leather_and_mail", 10, new int[]{2, 3, 4, 1}, 11, SoundEvents.ARMOR_EQUIP_GOLD,
            0.0F, 0.0F, () -> Ingredient.of(Tags.Items.LEATHER));

    private static final int[] HEALTH_PER_SLOT = new int[]{2, 3, 4, 1};
    ...
    public String getName() {
        return unrealizedideas.MOD_ID + ":" + this.name;
    }
